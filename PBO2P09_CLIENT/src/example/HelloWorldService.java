 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://example/", wsdlLocation = "http://localhost:8080/PBO2P09_SOAP_war_exploded/services/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/PBO2P09_SOAP_war_exploded/services/HelloWorld?wsdl");
